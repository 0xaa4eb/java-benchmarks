...
@IncludedInReport
public class TestGCStreamWithoutLoop {
    ...
    /*
manual:·gc.alloc.rate.norm                   5  avgt    5   ≈ 10⁻⁴              B/op
streamSequential:·gc.alloc.rate.norm         5  avgt    5   88.000 ±   0.001    B/op
    * */
    public static void main(String[] args) {

        BenchmarkRunner.run(TestGCStreamWithoutLoop.class);
    }
}
